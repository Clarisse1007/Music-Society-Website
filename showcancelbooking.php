...
if ($result_fetchStudentName && mysqli_num_rows($result_fetchStudentName) > 0) {
    ...
    // Fetch the booking information based on the student name, ordered by ascending booking_id
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result_fetchBooking && mysqli_num_rows($result_fetchBooking) > 0) {
        ...
        if (mysqli_query($mysqli, $sql_cancelBooking)) {
            // Update the remaining booking IDs to be consecutive
            ...
            // Redirect to viewbookingstatus.php with a success message

...
<body>
    ...
    <div class="main-content">
        <div class="side-navigationlist">
            <nav class="side">
                <table>
                    ...
                    <tr><td><a href="bookevent.php">Booking For Event</a></td></tr>
                    <tr><td><a href="#">Cancel Booking</a></td></tr>
                    <tr><td><a href="#">Cancel Registration</a></td></tr> <!--something like delete-->
                    <tr><td><a href="#">View Booking Status</a></td></tr>
                    <tr><td><a href="#">Print Ticket/Receipt/QR code</a></td></tr>
        ...
        <div class="container">
            ...
            <p><a href="feedbackform.php">Back To Form</a></p>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])){
                ...
                $improvements = trim($_POST['improvement']);
                    ...
                    echo '<script type="text/javascript">window.location.href = "home.html";</script>'; // Redirect if no POST data
                }
            ?>
        </div>
    </div>
    ...
    <footer>
        <div class="contactUs">
            ...
            <a href="https://example.com/instagram"><img src="ig.png" alt="ig" width="100px" height="auto"/></a>
        </div>
    </footer>
